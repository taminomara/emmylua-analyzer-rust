...
// pub fn analyze_name_expr(analyzer: &mut FlowBuilder, name_expr: LuaNameExpr) -> Option<()> {
...
// pub fn analyze_index_expr(analyzer: &mut FlowBuilder, index_expr: LuaIndexExpr) -> Option<()> {
