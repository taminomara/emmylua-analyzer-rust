use crate::{DbIndex, LuaMemberId, LuaMemberIndex, LuaMemberKey, LuaMemberOwner, LuaType};

pub fn migrate_member_when_type_resolve(db: &DbIndex, member_id: LuaMemberId) -> Option<()> {
...
//     let member_owner = get_owner_id(member_index, member_id)?;
